    ...
    <section id="home" className="relative h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Ambiente industrial representativo"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full pt-20">
        <div className="max-w-3xl">
          ...
          <p
            className="text-lg md:text-xl text-gray-300 mb-10 max-w-xl font-light leading-relaxed animate-fade-up"
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-up" style={{ animationDelay: "0.4s" }}>
            ...
            >
              ...
              <ChevronRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" size={20} />
            </a>
            ...
            <button
              ...
              aria-label="Ver nossas representadas"
            >
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-px h-24 bg-gradient-to-b from-white/0 to-blue-500 hidden lg:block" />
    </section>
  );
};
