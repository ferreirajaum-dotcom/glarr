      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl font-bold text-blue-950">
            Credibilidade que gera resultados
          </h3>
        </div>
          ...
          {brands.map((brand, i) => (
            ...
            >
              <div className="relative h-72 overflow-hidden flex items-center justify-center bg-gray-100">
                <img
                  ...
                  className={`transition-all duration-1000 ${
                    brand.name === "Fibraviva"
                      ? "max-h-[60%] w-auto object-contain p-8"
                      : "w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-110"
                  }`}
                />
                {brand.name !== "Fibraviva" && (
                  <div className="absolute inset-0 bg-blue-950/40 group-hover:bg-blue-950/10 transition-colors" />
                )}
              ...
              <div className="p-8">
                ...
                <p className="text-gray-500 mb-6 leading-relaxed text-sm font-sans">
                  {brand.desc}
                </p>
                <div className="flex items-center text-blue-600 font-bold text-xs uppercase tracking-widest">
                  Ver detalhes da representada
                  <div className="ml-2 h-px w-8 bg-blue-600 group-hover:w-16 transition-all duration-500" />
                </div>
              </div>
            </div>
          ))}
